...
class CarouselSliderWidget extends StatefulWidget {
  ...
  @override
  CarouselSliderWidgetState createState() => CarouselSliderWidgetState(_carouselController);
}
...
class CarouselSliderWidgetState extends State<CarouselSliderWidget>
  ...
  CarouselSliderWidgetState(this.carouselController);
  ...
  @override
  void didUpdateWidget(CarouselSliderWidget oldWidget) {
...
class CarouselOptions {
  ...
  /// The initial page to show when first creating the [CarouselSliderWidget].
  ///
  /// Defaults to 0.
...
class CarouselSliderControllerImpl implements CarouselSliderController {
  ...
  /// Animates the controlled [CarouselSliderWidget] to the next page.
  ///
  ...
  /// Animates the controlled [CarouselSliderWidget] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [CarouselSliderWidget].
  ///
  ...
  /// Animates the controlled [CarouselSliderWidget] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Starts the controlled [CarouselSliderWidget] autoplay.
  ///
  ...
  /// Stops the controlled [CarouselSliderWidget] from autoplaying.
  ///
...
class CarouselState {
  ...
  /// The initial index of the [PageView] on [CarouselSliderWidget] init.
  ///
  int initialPage = 0;
