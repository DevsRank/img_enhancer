...
class ExploreGridViewWidget extends StatefulWidget {
  ...
  @override
  State<ExploreGridViewWidget> createState() => _ExploreGridViewWidgetState();
}

class _ExploreGridViewWidgetState extends State<ExploreGridViewWidget> {
