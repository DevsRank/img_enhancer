...
class _CreateCategoryScreenState extends State<CreateCategoryScreen> {
  ...
  void _text2VideoGeneratorFunction() async {
    ...
    try {
      ...
      //   return;
      // } else if(context.read<InAppPurchaseSubscriptionBloc>().state.subscriptionStatus == InAppPurchaseSubscriptionStatus.DIALY_SUBSCRIPTION_USAGE_LIMIT_EXCEEDED) {
      ...
      // }
        ...
        final img = _imgPickerCubit.state.img ?? "";
        ...
        final idResponse = await ApiRequest.generateImg(img: img);

        if(idResponse.success) {

          await 6.second.wait();

          final imgResponse = await ApiRequest.getImgStatus(id: idResponse.value);
          ...
          context.showSnackBar(msg: idResponse.msg);
        }
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                    ...
                    BlocBuilder<ImgPickerBloc, ImgPickerState>(
                        builder: (context, imgPickerState) {
                          return imgPickerState.img != null
                              ...
                              : ImgWidget(imgType: imgPickerState.imgType, img: imgPickerState.img!, fit: BoxFit.cover)
                              : Container(
                            width: double.maxFinite,
                            height: double.maxFinite,
                            alignment: Alignment.center,
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: "What should we zoom on? (Optional)",
                    hintStyle: TextStyle(
                      color: kGreyColor,
            ...
            else if(widget.subCategoryType == SubCategoryType.remove_object) ...[
              BlocBuilder<ImgPickerBloc, ImgPickerState>(
                  builder: (context, imgPickerState) {
