...
class ViewExploreScreen extends StatefulWidget {
  final dynamic tag;
  final CreateCategoryModel categoryModel;

  const ViewExploreScreen({super.key, this.tag, required this.categoryModel});

  @override
  State<ViewExploreScreen> createState() => _ViewExploreScreenState();
}

class _ViewExploreScreenState extends State<ViewExploreScreen> {
